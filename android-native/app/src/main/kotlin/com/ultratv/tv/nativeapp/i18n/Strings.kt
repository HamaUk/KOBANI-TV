...
private val KU = Strings(
    navHome = "سەرەکی", navLive = "ڕاستەوخۆ", navGuide = "ڕێبەر", navMovies = "فیلمەکان",
    navSeries = "زنجیرەکان", navFavorites = "دڵخوازەکان", navSearch = "گەڕان",
    navCategories = "هاوپۆلەکان", navMultiview = "فرە-بینین",
    navRecordings = "تۆمارەکان", navSettings = "ڕێکخستنەکان",

    homeWelcome = "بەخێربێیت بۆ Ultra TV",
    homeSubtitle = "بنیاتنانی ڕەسەن · ئامادەیە بۆ کۆنترۆڵ",
    homeContinueWatching = "بەردەوام بە لە سەیرکردن",
    homeRecentlyWatched = "دواین سەیرکراوەکان",
    homeFeaturedChannels = "کەناڵە هەڵبژێردراوەکان",
    homeFeaturedMovies = "فیلمەکان",
    homeFeaturedSeries = "زنجیرەکان",
    onboardingMacLabel = "ماکی ئامێرەکەت:",
    onboardingOpenSettings = "کردنەوەی ڕێکخستنەکان",
    onboardingFirstTime = "ڕێکخستنی یەکەم جار",
    onboardingTwoPaths = "دوو ڕێگا بۆ زیادکردنی دابینکەر:",
    onboardingPathManual = "١. بچۆ ڕێکخستنەکان → +Xtream / +M3U / +M3U file / +Stalker، فۆڕمەکە پڕبکەرەوە.",
    onboardingPathCloud = "٢. بەکارهێنانی Cloudflare Worker، ماکەکەت بنووسە لە داشبۆردەکەی، پاشان لە ڕێکخستنەکان → هاوکاتکردن لە هەورەوە.",

    parentalPinEnabled = "نهێنی خێزانی: چالاکە",
    parentalPinNotSet = "نهێنی خێزانی: دانەنراوە",
    parentalSetPin = "دانانی وشەی نهێنی",
    parentalChangePin = "گۆڕینی وشەی نهێنی",
    parentalClearPin = "سڕینەوە",
    parentalManageLocked = "بەڕێوەبردنی کەناڵە داخراوەکان…",
    parentalSetTitle = "دانانی نهێنی خێزانی",
    parentalPinHint = "وشەی نهێنی (٤ ژمارە)",
    parentalConfirmHint = "دڵنیابوونەوە لە وشەی نهێنی",
    parentalLockedTitle = "🔒 ناوەڕۆکی داخراو",
    parentalEnterPin = "وشەی نهێنی خێزانی بنووسە بۆ بەردەوامبوون.",
    parentalWrongPin = "وشەی نهێنی هەڵەیە.",
    parentalUnlock = "کردنەوە",

    categoriesManage = "بەڕێوەبردنی هاوپۆلەکان",
    categoriesFilterHint = "پاڵاوتنی ناوەکانی هاوپۆل…",
    categoriesHideAll = "شاردنەوەی هەموو پاڵێوراوەکان",
    categoriesShowAll = "پیشاندانی هەموو پاڵێوراوەکان",
    categoriesHideAdult = "🔞 شاردنەوەی گەورەساڵان",
    categoriesResetAll = "گێڕانەوەی هەمووی",
    categoriesEmpty = "هیچ هاوپۆلێک نییە — دابینکەرێک زیاد بکە.",
    categoriesShow = "پیشاندان",
    categoriesHide = "شاردنەوە",
    categoriesCountTemplate = "گشتی %1\$d · %2\$d پیشاندراو · %3\$d شاراوە",

    wizardWelcomeTitle = "👋 بەخێربێیت بۆ Ultra TV",
    wizardAddProviderTitle = "📡 زیادکردنی دابینکەر",
    wizardDoneTitle = "🎉 تەواو بوو",
    wizardStepTemplate = "هەنگاوی %1\$d / %2\$d",
    wizardIntro1 = "Ultra TV ئەپێکی ڕەسەنی Android-TV IPTV یە. پشتیوانی لە Xtream Codes, M3U / M3U8 دەکات.",
    wizardIntro2 = "دیزاینێکی مۆدێرنی هەیە. کۆنترۆڵکردن زۆر ئاسانە.",
    wizardTwoPaths = "دوو ڕێگا هەیە:",
    wizardPathManual = "• ڕێکخستنەکان → +Xtream / +M3U URL / +M3U file / +Stalker. فۆڕمەکە پڕبکەرەوە.",
    wizardPathCloud = "• یان Cloudflare Worker بەکاربهێنە، پاشان لە ڕێکخستنەکان → هاوکاتکردن لە هەورەوە.",
    wizardTipsHead = "ئامۆژگارییەکان:",
    wizardTipDefault = "• ★ دابینکەری سەرەکی لە ڕێکخستنەکانە.",
    wizardTipSleep = "• 💤 کاتی خەوتن + 📊 ئامارەکانی پەخش لە ڕووکاری لێدەرەکەدان.",
    wizardTipLock = "• 🔒 داخستنی کەناڵەکان لە ڕێکخستنەکان → خێزانی.",
    wizardTipBackup = "• 💾 پاشەکەوتکردن هەموو زانیارییەکانت دەپارێزێت.",
    wizardTipGuide = "• 🗓 ڕێبەر → نوێکردنەوەی EPG بەرنامەی ١٢ کاتژمێر دەهێنێت.",
    wizardBack = "گەڕانەوە",
    wizardNext = "دواتر",
    wizardAddProviderCta = "زیادکردنی دابینکەر →",
    wizardSkip = "پەڕاندن بۆ ئێستا",

    lockChannelsTitle = "داخستنی کەناڵەکان",
    lockChannelsSubtitle = "کەناڵە داخراوەکان پێویستیان بە وشەی نهێنی هەیە. گشتی %1\$d · %2\$d داخراو",
    lockChannelsFilterHint = "پاڵاوتنی کەناڵەکان…",
    lockChannelsLock = "داخستن",
    lockChannelsUnlock = "کردنەوە",

    guideClickHint = "کرتە لە کەناڵێک بکە بۆ بینینی بەرنامەکانی.",
    guideLoadingEpg = "هێنانی EPG…",
    guideProgrammesTemplate = "%1\$d بەرنامە هێنرا · %2\$d کەناڵ",
    guideLoading = "چاوەڕێبە…",
    guideRefreshXmltv = "نوێکردنەوەی xmltv",
    guideNoChannels = "هیچ کەناڵێک نییە — دابینکەرێک زیاد بکە.",

    addProviderAdd = "زیادکردن",
    addProviderXtreamTitle = "زیادکردنی Xtream Codes",
    addProviderM3uTitle = "زیادکردنی M3U",
    addProviderStalkerTitle = "زیادکردنی Stalker",
    fieldNameOptional = "ناو (ئارەزوومەندانە)",
    fieldServerUrl = "بەستەری سێرڤەر (http://host:port)",
    fieldUsername = "ناوی بەکارهێنەر",
    fieldPassword = "وشەی نهێنی",
    fieldPlaylistUrl = "بەستەری لیست",
    fieldPortalUrl = "بەستەری پۆرتاڵ",
    fieldDeviceMac = "ماکی ئامێر (XX:XX:XX:XX:XX:XX)",

    settingsAutoImportTitle = "📡 هێنان بە شێوەی خۆکارانە",
    settingsYourMac = "ماکی تۆ:",
    settingsMacHint = "ئەم ماکە بنووسە لە داشبۆردەکەت، پاشان کرتە لە هاوکاتکردن بکە.",
    settingsConfigPasswordLabel = "وشەی نهێنی ڕێکخستن: ",
    settingsConfigPasswordNone = "(نییە)",
    settingsSet = "دانان",
    settingsSyncing = "لە کارکردندایە…",
    settingsSyncFromCloud = "هاوکاتکردن لە هەورەوە",
    settingsAddProviderTitle = "➕ زیادکردنی دابینکەر",
    settingsAddProviderHint = "کرتە لە دوگمەیەک بکە بۆ کردنەوەی فۆڕمەکە.",
    settingsAddXtream = "+ Xtream Codes",
    settingsAddM3uUrl = "+ M3U URL",
    settingsAddM3uFile = "+ پەڕگەی M3U…",
    settingsAddStalker = "+ Stalker",
    settingsConfiguredHeader = "دابینکەرە زیادکراوەکان",
    settingsNoneYet = "(تا ئێستا هیچ نییە)",
    settingsDefaultBadge = "★ سەرەکی",
    settingsSetDefault = "دانان وەک سەرەکی",
    settingsResync = "دووبارە هاوکاتکردنەوە",
    settingsBackupTitle = "💾 پاشەکەوتکردن",
    settingsBackupHint = "لیستەکان و دڵخوازەکانت دەپارێزێت بە شێوەی JSON.",
    settingsBackupExport = "هەناردەکردنی پاشەکەوت",
    settingsBackupImport = "هێنانی پاشەکەوت…",
    settingsParentalHint = "کاتێک وشەی نهێنی دادەنرێت، کەناڵە نەشیاوەکان دادەخرێن.",
    settingsConfigPwdDialogTitle = "وشەی نهێنی ڕێکخستن",
    settingsConfigPwdDialogHint = "بۆ پاراستنی هەژمارەکەت وشەی نهێنی دابنێ.",
    settingsConfigPwdFieldLabel = "وشەی نهێنی (بیندراو)",
    settingsConfigPwdFieldPlaceholder = "بەتاڵ جێیبهێڵە بۆ سڕینەوە",
    settingsWorkerDialogTitle = "دانانی بەستەری Cloudflare",
    settingsWorkerDialogHint = "بەستەری تایبەتی خۆت دابنێ.",
    settingsWorkerFieldLabel = "بەستەری Worker",
    toastBackupSaved = "پاشەکەوتکرا",
    toastSaveFailed = "سەرکەوتوو نەبوو: ",
    toastEmptyFile = "پەڕگەکە بەتاڵە",
    toastConfigPasswordSaved = "وشەی نهێنی خەزنکرا",

    prefSidebar = "لای چەپ",
    prefTopBar = "سەرەوە",
    prefThemeDark = "تاریک",
    prefThemeAmoled = "ئامۆلێد",
    prefThemeBlue = "شین",
    prefDefaultPlayer = "لێدەری سەرەکی",
    prefPlayerInternal = "ناوخۆیی (Media3)",
    prefPlayerExternal = "دەرەکی (VLC / MX)",
    prefAutoSyncHint = "هێنانی لیستەکان لە کاتی کردنەوەی ئەپەکە.",
    prefShowChannelNumbers = "پیشاندانی ژمارەی کەناڵەکان",
    prefShowChannelNumbersHint = "ژمارەی کەناڵەکان لە تەنیشت ناوەکانیان پیشان دەدات.",
    prefHideAdult = "شاردنەوەی کەناڵە نەشیاوەکان",
    prefHideAdultHint = "بەتەواوی کەناڵە نەشیاوەکان دەشارێتەوە.",
    prefResume = "بەردەوامبوون",
    prefResumeHint = "فیلمەکان لەو شوێنە دەکاتەوە کە بەجێتهێشتبوون.",
    prefAutoPlayNext = "لێدانی ئەڵقەی دواتر بەخۆکارانە",
    prefAutoPlayNextHint = "ئەڵقەی دواتر لێدەدات کە ئەڵقەیەک تەواو دەبێت.",
    prefLaunchAtBoot = "کردنەوە لە کاتی داگیرساندنی تیڤی",
    prefLaunchAtBootHint = "ئەپەکە دەکرێتەوە ڕاستەوخۆ دوای هەڵبوونی ئامێرەکە.",
    prefAutoPlayLast = "لێدانی کۆتا کەناڵ",
    prefAutoPlayLastHint = "ڕاستەوخۆ کۆتا کەناڵ یان فیلم لێدەدات لە کاتی کردنەوە.",
    prefIntervalLaunch = "لە هەموو کردنەوەیەک",
    prefInterval6 = "هەموو ٦ کاتژمێرێک",
    prefInterval12 = "هەموو ١٢ کاتژمێرێک",
    prefInterval24 = "هەموو ٢٤ کاتژمێرێک",

    favoritesEmpty = "هیچ دڵخوازێک نییە — کرتە لە ☆ بکە بۆ زیادکردن.",
    favoritesMoviesSection = "فیلمەکان — %1\$d",
    favoritesSeriesSection = "زنجیرەکان — %1\$d",
    detailLoading = "چاوەڕێبە…",
    seriesNoEpisodes = "هیچ ئەڵقەیەک بەردەست نییە.",
    multiViewTitle = "فرە-بینین",
    multiViewHint = "کرتە لە چوارچێوەیەک بکە بۆ زیادکردنی کەناڵێک.",
    multiViewPickTemplate = "کەناڵێک هەڵبژێرە بۆ چوارچێوەی %1\$d:",
    recordingsPlay = "لێدان",
    recordingsOpenWith = "کردنەوە لە ڕێگەی…",
    playerOff = "کوژاوە",
    playerAudioTemplate = "دەنگ (%1\$d)",
    playerSubtitlesTemplate = "ژێرنووس (%1\$d)",

    liveAllChannels = "هەموو کەناڵەکان",
    liveZappingEyebrow = "گۆڕینی کەناڵ",
    liveOnAirPill = "ڕاستەوخۆ",
    liveThen = "دواتر",
    liveDayScheduleEyebrow = "بەرنامەی ئەمڕۆ",
    liveNoEpgForChannel = "هیچ بەرنامەیەک بەردەست نییە بۆ ئەم کەناڵە.",
    updateAvailableEyebrow = "نوێکردنەوە بەردەستە",
    updateLater = "دواتر",
    updateInstall = "دابەزاندن ئێستا",
    updateDownloading = "لە دابەزاندندایە…",
    settingsTelemetryTitle = "ناردنی کێشەکان",
    settingsTelemetryHint = "ناردنی کێشەکانی ئەپەکە بۆ گەشەپێدەر.",
    settingsCheckForUpdates = "گەڕان بۆ نوێکردنەوە",
    settingsCheckingForUpdates = "لە گەڕاندایە…",
    settingsUpToDateTemplate = "نوێترین وەشانت هەیە (v%s)",
    settingsUpdateAvailableTemplate = "وەشانی %s بەردەستە",
    backupEncryptHint = "پاشەکەوتەکەت وشەی نهێنی داوا دەکات. پێشنیار دەکرێت وشەی نهێنی دابنێیت.",
    backupEncryptFieldLabel = "وشەی نهێنی (ئارەزوومەندانە)",
    backupEncryptFieldPlaceholder = "بەتاڵ جێیبهێڵە بۆ ئاسایی",
    liveChannelsCountTemplate = "%1\$d کەناڵ",
    liveNoChannelsInCategory = "هیچ کەناڵێک لەم هاوپۆلەدا نییە.",
    railOther = "ئەوانی تر",
    open = "کردنەوە",
    ...
    sleep1h = "١ کاتژمێر",
    sleep2h = "٢ کاتژمێر",
    sleepCancel = "پەشیمانبوونەوە",
    sleepReached = "کاتی خەوتن تەواو بوو — لێدان وەستێنرا",
    recordingQueuedTemplate = "تۆمارکردن چاوەڕێیە (زۆرترین %1\$d خولەک)",
    statResolution = "ڕوونی",
    statVideoCodec = "کۆدێکی ڤیدیۆ",
    statFrameRate = "خێرایی وێنە",
    statVideoBitrate = "بیتڕەیتی ڤیدیۆ",
    statAudioCodec = "کۆدێکی دەنگ",
    statAudioChannels = "کەناڵی دەنگ",
    statBuffered = "چاوەڕێکراو",
    statDroppedFrames = "وێنە فەوتاوەکان",

    toastBackupReady = "پاشەکەوت ئامادەیە — پەڕگەیەک هەڵبژێرە.",
    toastRestoredTemplate = "%1\$d دابینکەر هێنرایەوە، %2\$d دڵخواز",
    toastRestoreFailed = "سەرکەوتوو نەبوو: ",
    toastRecordingQueued = "تۆمارکردن چاوەڕێیە — بڕوانە تۆمارەکان",

    settingsTitle = "ڕێکخستنەکان", settingsDisplay = "پیشاندان و لێدان",
    settingsParental = "کۆنترۆڵی خێزانی", settingsBackup = "پاشەکەوتکردن",
    settingsLanguage = "زمان", settingsTheme = "ڕووکار",
    settingsMenuPosition = "شوێنی پێڕست", settingsAutoSync = "هاوکاتکردنی خۆکارانە",
    settingsRefreshPlaylists = "نوێکردنەوەی لیستەکان",

    movieDetailPlot = "چیرۆک", seriesDetailEpisodes = "ئەڵقەکان",
    moviesTitle = "فیلمەکان", seriesTitle = "زنجیرەکان",
    noMovies = "هیچ فیلمێک نییە — دابینکەرێک زیاد بکە.",
    noSeries = "هیچ زنجیرەیەک نییە — دابینکەرێک زیاد بکە.",

    playerSleep = "خەوتن", playerStats = "ئامارەکان", playerTracks = "کوالێتی",
    playerDisplay = "پیشاندان", playerExternal = "لێدەری دەرەکی",
    playerCast = "پەخشکردن", playerRecord = "تۆمارکردن",
    playerAspect = "پێوانە", playerSpeed = "خێرایی",
    playerZapHint = "▲ ▼ بۆ گۆڕینی کەناڵ",

    searchPlaceholder = "بگەڕێ بۆ کەناڵەکان، فیلمەکان، زنجیرەکان…",
    searchRecent = "دوایین:", searchClear = "سڕینەوە",
    searchNoMatches = "هیچ ئەنجامێک نییە.",

    recordingsTitle = "تۆمارەکان",
    recordingsEmpty = "هیچ تۆمارێک نییە. فیلمێک یان ئەڵقەیەک بکەرەوە و کرتە لە ⏺ بکە بۆ تۆمارکردن.",
    recordingStatusQueued = "چاوەڕێیە",
    recordingStatusRunning = "لە دابەزاندندایە…",
    recordingStatusDone = "خەزنکرا",
    recordingStatusFailed = "سەرکەوتوو نەبوو",
    recordingStatusCancelled = "پەشیمانبووەوە",

    live = "ڕاستەوخۆ", movies = "فیلمەکان", series = "زنجیرەکان", categories = "هاوپۆلەکان",
    tvGuide = "ڕێبەر", favorites = "دڵخوازەکان",
    play = "لێدان", resume = "بەردەوامبوون", cancel = "پەشیمانبوونەوە", close = "داخستن",
    save = "خەزنکردن", delete = "سڕینەوە", confirm = "دڵنیابوونەوە",
    dismiss = "لابردن", change = "گۆڕین",
)
