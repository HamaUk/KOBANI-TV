...
import { SportsScreen } from "@app/screens/SportsScreen";
...
export function App() {
  ...
  const sessionCode = useSessionStore((s) => s.code);
  ...
  }, [initParental, initI18n, initUi]);

  // Use provider 1 automatically if logged in
  useEffect(() => {
    if (sessionCode) setActive(1);
  }, [sessionCode, setActive]);
